            ...
            <div class="welcome suspension">
              ...
              <div class="welcome-text">
                <div class="welcome-title">
                  {{ authStore.userAccount?.full_name + ', ' + getGreet() }}
                </div>
          ...
          >
            <div class="working el-card is-hover-shadow">
              ...
              <div class="working-text">
                Bạn đã làm việc hôm nay:
                <span class="time">
                  {{ state.workingTimeFormat }}
                </span>
              </div>
              <div class="working-opt working-rest">
                {{
                  state.pauseWork ? 'Continue to work' : 'have a bit of rest'
                }}
              </div>
            </div>
          </el-col>
                ...
                <el-scrollbar>
                  <div class="new-user-item">
                    ...
                    <div class="new-user-base">
                      ...
                      <div class="new-user-time">12分钟前 Joined us</div>
                    </div>
                    <Icon
      ...
      <div class="growth-chart">
        <el-row :gutter="15">
          ...
          >
            <el-card
              shadow="hover"
              :header="'Member source'"
            >
              <div
                class="user-source-chart"
                :ref="chartRefs.set"
              ></div>
            </el-card>
          </el-col>
...
import { WORKING_TIME } from '@/constants/cachedKey';
...
const formatSeconds = (seconds: number) => {
  ...
  result =
    hourTime +
    ' giờ ' +
    ((minuteTime >= 10 ? minuteTime : '0' + minuteTime) + ' phút ') +
    ((secondTime >= 10 ? secondTime : '0' + secondTime) + ' giây ');
  if (dayTime > 0) {
    result = dayTime + 'day' + result;
  }
  return result;
};
